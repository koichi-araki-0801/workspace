// =============================================================================
// users.spec.ts — 管理者ユーザー作成 → 初回パスワード変更の実機検証
// =============================================================================
// chromium project で走る(サーバは sproc フェイク + 一時 dataRoot)。一時パスワードは
// サーバが払い出しの 1 回だけ平文で返す値で、以後どこにも残らない。この「1 回だけ」は
// 画面の表示と実際にログインできる資格情報の両方が揃って初めて確かめられる。
//
