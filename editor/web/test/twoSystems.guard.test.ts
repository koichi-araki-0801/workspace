...
// =============================================================================
// CLAUDE.md「editor 2系統の原則」の不変条件を機械的に守る。過去に起きた 2 つの退行を
// 直接落とすことが目的:
//   - `aa9bd65` 型: 素の `.jinja-chip.jinja-var` に背景を直書きし、編集タブへハイライトが
//     漏れる退行。→ ハイライト背景は `.jinja-vars-highlight` 配下のみ、を検証。
//   - `42938a0` 型: filled / サンプルを全ファンド共通ダミーに潰し、編集タブが実値を失う
