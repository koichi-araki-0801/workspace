...
rem Prerequisite: this repository is already git-cloned and the bundle (tar.gz / .sha256 /
rem bundle.key) is at the repo root (or bk\). This script never downloads; fetch first with
rem fetch-offline-bundle.bat on a machine with network access.
