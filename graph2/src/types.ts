...
// types.ts — 共通型定義
// -----------------------------------------------------------------------------
// graph2 全体で参照する基本データ型。strictNullChecks 有効下で運用するため、
...
export interface LayoutItem {
  ...
  // 逃がす印。layout.ts markTopBandSmallRight で立て、label_placement.ts topBandSmallRight が
  ...
  // 折らず pie 真下中央へ leaderless で据える印。layout.ts markBottomCenterBelow が立て、
  // label_placement.ts bottomCenterBelow が参照する。
  ...
  // layout.ts markDenseSideOutsidePush が立てる。
