...
// =============================================================================
// SVG 属性を組み立てる手段をここ 1 つ (`attr`) に絞る。「エスケープすべき属性」を
// 列挙する形だと、同じ 1 行の中で `font-family` は escape され `fill` は素通し、という
// 非対称が生まれる (`--font-weight '400" onload="alert(1)'` で全 `<text>` に onload が
